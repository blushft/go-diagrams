...
func init(){
	...
	Register(namespace, "ComputeEngine", Compute.ComputeEngine)
	Register(namespace, "ContainerOptimizedOs", Compute.ContainerOptimizedOs)
	Register(namespace, "Functions", Compute.Functions)
	Register(namespace, "GkeOnPrem", Compute.GkeOnPrem)
	Register(namespace, "Gpu", Compute.Gpu)
	Register(namespace, "KubernetesEngine", Compute.KubernetesEngine)
	Register(namespace, "Run", Compute.Run)
	Register(namespace, "AppEngine", Compute.AppEngine)
}