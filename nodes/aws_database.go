...
func init() {
  ...
  Register(namespace, "Aurora", Database.Aurora)
  Register(namespace, "QuantumLedgerDatabaseQldb", Database.QuantumLedgerDatabaseQldb)
  Register(namespace, "Timestream", Database.Timestream)
  Register(namespace, "DynamodbGlobalSecondaryIndex", Database.DynamodbGlobalSecondaryIndex)
  Register(namespace, "DynamodbTable", Database.DynamodbTable)
  Register(namespace, "RdsOnVmware", Database.RdsOnVmware)
  Register(namespace, "DatabaseMigrationService", Database.DatabaseMigrationService)
  Register(namespace, "Database", Database.Database)
  Register(namespace, "DynamodbDax", Database.DynamodbDax)
  Register(namespace, "Rds", Database.Rds)
  Register(namespace, "Redshift", Database.Redshift)
  Register(namespace, "DocumentdbMongodbCompatibility", Database.DocumentdbMongodbCompatibility)
  Register(namespace, "Dynamodb", Database.Dynamodb)
  Register(namespace, "Elasticache", Database.Elasticache)
  Register(namespace, "Neptune", Database.Neptune)
}
