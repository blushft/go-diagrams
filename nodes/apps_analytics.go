...
func init() {
	...
	Register(namespace, "Dbt", Analytics.Dbt)
	Register(namespace, "Hive", Analytics.Hive)
	Register(namespace, "Norikra", Analytics.Norikra)
	Register(namespace, "Singer", Analytics.Singer)
	Register(namespace, "Spark", Analytics.Spark)
	Register(namespace, "Storm", Analytics.Storm)
	Register(namespace, "Databricks", Analytics.Databricks)
	Register(namespace, "Flink", Analytics.Flink)
	Register(namespace, "Hadoop", Analytics.Hadoop)
	Register(namespace, "Metabase", Analytics.Metabase)
	Register(namespace, "Tableau", Analytics.Tableau)
	Register(namespace, "Beam", Analytics.Beam)
}