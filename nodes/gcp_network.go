...
func init() {
	...
	Register(namespace, "Cdn", Network.Cdn)
	Register(namespace, "DedicatedInterconnect", Network.DedicatedInterconnect)
	Register(namespace, "LoadBalancing", Network.LoadBalancing)
	Register(namespace, "Router", Network.Router)
	Register(namespace, "StandardNetworkTier", Network.StandardNetworkTier)
	Register(namespace, "Dns", Network.Dns)
	Register(namespace, "Nat", Network.Nat)
	Register(namespace, "Network", Network.Network)
	Register(namespace, "VirtualPrivateCloud", Network.VirtualPrivateCloud)
	Register(namespace, "Armor", Network.Armor)
	Register(namespace, "FirewallRules", Network.FirewallRules)
	Register(namespace, "PartnerInterconnect", Network.PartnerInterconnect)
	Register(namespace, "PremiumNetworkTier", Network.PremiumNetworkTier)
	Register(namespace, "ExternalIpAddresses", Network.ExternalIpAddresses)
	Register(namespace, "Routes", Network.Routes)
	Register(namespace, "TrafficDirector", Network.TrafficDirector)
	Register(namespace, "Vpn", Network.Vpn)
}