...
func init() {
	...
	Register(namespace, "Influxdb", Database.Influxdb)
	Register(namespace, "Mariadb", Database.Mariadb)
	Register(namespace, "Postgresql", Database.Postgresql)
	Register(namespace, "Mysql", Database.Mysql)
	Register(namespace, "Oracle", Database.Oracle)
	Register(namespace, "Scylla", Database.Scylla)
	Register(namespace, "Couchbase", Database.Couchbase)
	Register(namespace, "Couchdb", Database.Couchdb)
	Register(namespace, "Hbase", Database.Hbase)
	Register(namespace, "Janusgraph", Database.Janusgraph)
	Register(namespace, "Cassandra", Database.Cassandra)
	Register(namespace, "Clickhouse", Database.Clickhouse)
	Register(namespace, "Cockroachdb", Database.Cockroachdb)
	Register(namespace, "Dgraph", Database.Dgraph)
	Register(namespace, "Druid", Database.Druid)
	Register(namespace, "Mongodb", Database.Mongodb)
	Register(namespace, "Mssql", Database.Mssql)
	Register(namespace, "Neo4J", Database.Neo4J)
}
